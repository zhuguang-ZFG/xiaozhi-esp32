...
// $110/$111 于 2026-09-11 用户拍板提速 5000→12000（与 MK38 换纸机金标同值，
// 同机型同 100 steps/mm 实机现役证据；G-code F8000 不再被压到 83mm/s）。
// 注意：Grbl `$RST=$` 恢复出厂会回落机头默认 5000 → 指纹失配拒画，
// 刷机/恢复出厂后必须重写 $110/$111=12000。无 §9-G′ 长名项（4 月基线无该守卫）。
